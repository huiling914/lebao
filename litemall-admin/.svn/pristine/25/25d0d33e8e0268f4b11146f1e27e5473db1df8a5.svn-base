    ...
    getData(){
      ...
      if(this.chartData.rows=[]){
        ...
        if(this.listQuery.beginTime){
          this.chartData.rows.push({amount:0,orders:0,products:0,day:this.transDate(this.listQuery.beginTime)})
        }
        if(this.listQuery.endTime){
          this.chartData.rows.push({amount:0,orders:0,products:0,day:this.transDate(this.listQuery.endTime)})
        }
        if(!this.listQuery.endTime&&!this.listQuery.beginTime){
          this.chartData.rows.push({amount:0,orders:0,products:0,day:this.getNowFormatDate()})
        }
