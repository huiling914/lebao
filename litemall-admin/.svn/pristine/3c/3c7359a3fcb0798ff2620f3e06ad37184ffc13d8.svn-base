    ...
    <div class="app-container">
        ...
        <el-dialog :visible.sync="refundVisible" title="退款详情" width="800">
            ...
            <el-form :data="refundForm" label-position="left">
                ...
                <el-form-item label="审核时间" v-if="refundForm.auditTime">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button :loading="auditLoading" v-if="!refundForm.auditResult" type="primary" @click="auditRefund">审核</el-button>
...
<script>
    import {listOrder, shipOrder, refundOrder, detailOrder, refundList, detailRefund,feedBack,auditRefund} from '@/api/order'
        ...
        methods: {
            ...
            getRefundList() {
                ...
                if(this.orderStatus){
                    ...
                    this.listQuery.refundStatus='0,2,3'
                }
            ...
            auditRefund(){
                ...
                if(this.auFeedback.result==undefined){
                    ...
                    auditRefund(this.auFeedback).then((res)=>{
                        this.auditLoading=false
                        this.getRefundList()
            ...
            handleDownload() {
                this.downloadLoading = true
                    const tHeader = ['退款编号', '用户ID', '学校名称','课程名称', '退款余额', '退款宝宝币','学校审核状态','学校审核意见','学校审核时间','学校审核人员']
                    const filterVal = ['sn', 'userId', 'orgName', 'courseName', 'type', 'balance', 'vouchers', 'auditResult','auditFeedback','auditTime','auditAdminId']
