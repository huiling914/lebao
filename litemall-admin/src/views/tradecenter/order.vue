<template>
    <div class="app-container">
        ...
        <div class="filter-container">
            <el-date-picker style="width:180px;" v-model="listQuery.beginTime" class="filter-item" clearable type="date" value-format="yyyyMMdd" align="right" placeholder="起始日期"/><span class="filter-item">&nbsp;至</span>
            <el-date-picker style="width:180px;" v-model="listQuery.endTime" class="filter-item" clearable type="date" value-format="yyyyMMdd" align="right" placeholder="结束日期"/>
            ...
            <el-input  v-model="listQuery.user" clearable class="filter-item" style="width: 180px;"
                      placeholder="请输入用户ID"/>
            <el-input  v-model="listQuery.sn" clearable class="filter-item" style="width: 180px;" placeholder="请输入订单编号"/>
            <el-select v-model="listQuery.status" clearable style="width: 180px" class="filter-item"
                       placeholder="请选择订单状态">
    ...
    export default {
        ...
        methods: {
            ...
            handleDownload() {
                ...
                downQuery.limit=-1
                handleDownload(tHeader,filterVal,downQuery,'订单信息',listOrder)
